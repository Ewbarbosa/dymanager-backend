...
CREATE TABLE "client_process" (
    ...
    CONSTRAINT "client_process_pkey" PRIMARY KEY ("client_id","process_id")
);
...
-- AddForeignKey
ALTER TABLE "client_process" ADD CONSTRAINT "client_process_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "clients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "client_process" ADD CONSTRAINT "client_process_process_id_fkey" FOREIGN KEY ("process_id") REFERENCES "process"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
